...
module ProcessManager
  class Config
    ...
    def validate_log_and_pid_dir(errors)
      FileUtils.mkdir_p(ProcessManager::Config.config[:log_dir]) unless File.exist?(ProcessManager::Config.config[:log_dir])
      FileUtils.mkdir_p(ProcessManager::Config.config[:pid_dir]) unless File.exist?(ProcessManager::Config.config[:pid_dir])
